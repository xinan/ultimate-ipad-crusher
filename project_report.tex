...
\begin{description}[labelindent=1cm]
	\item[D.2.7] Distribution, Maintenance, and Enhancement
	\item[D.2.11] Software Architectures 
	\item[H.5.2] User Interfaces
\end{description}

\subsubsection{Keywords:}
\begin{description}[labelindent=1cm]
	\item Architecture, User Interface, Data Analysing
\end{description}

\subsubsection{Implementation Software and Hardware:}
\begin{description}[labelindent=1cm]
	\item Python, Ruby
\end{description}
\end{abstract}
